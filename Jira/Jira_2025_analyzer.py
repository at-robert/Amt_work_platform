...
def jira_to_csv(search_result_, project_name_,para_):
    ...
    data = [[issue.fields.priority,issue.key, issue.fields.status,issue.fields.assignee,time_str_covert(issue.fields.created),issue.raw['fields']['customfield_10040'],issue.fields.summary,time_str_covert(issue.fields.updated)]
    for issue in search_result_]

    header = ["Priority","Key", "Status","Assignee","Created","VendorCR","Summary","Updated"]
